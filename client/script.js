...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/HelloWorld').then((res) => {
        console.log(res.data)
        const repeatButton = document.getElementById('repeat-text')
...
const getQuery =() => {
    axios.get('http://localhost:3000/query-test?food=nachos').then((res) => {
        console.log(res.data)
    })
}
